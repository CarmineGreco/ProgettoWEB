			...
			<div class="card-header bg-white">
				<div
					...
					<div class="co my-auto">
						<h4 class="mb-0">
							Thanks for your Order,<span class="change-color">Anjali</span> !
						</h4>
					</div>
							...
							<div class="card-body">
								...
								<div class="row ">
									...
									<div class="co mt-auto">
										<div class="progress">
											<div class="progress-bar progress-bar rounded"
												style="width: 18%" role="progressbar" aria-valuenow="25"
												aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<div class="media row justify-content-between ">
											<div class="col-auto text-right">
											...
											<div class="flex-col">
												<span> <small class="text-right mr-sm-2">Out
														for delivary</small><i class="fa fa-circle"></i></span>
											</div>
											<div class="col-auto flex-col-auto">
												<smallclass ="text-rightmr-sm-2">Delivered</small>
